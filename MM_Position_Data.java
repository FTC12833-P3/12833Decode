...
public class MM_Position_Data {
    ...
    public MM_Spline splineToCollectFirstSpikeMark = new MM_Spline(new double[]{-20, -1.4, 14.7, 12}, new double[]{20 * MM_OpMode.alliance, 17.7 * MM_OpMode.alliance, 20.3 * MM_OpMode.alliance, 33 * MM_OpMode.alliance}, MM_Autos.SPLINE_DETAIL_LEVEL, true);
